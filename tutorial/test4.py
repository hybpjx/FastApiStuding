...
SECRET_KEY = "c54e8d6bd4308c9ff9a6089c741b524e1015b3853c22a208328438f0a2725d0d"  # 生成密钥 openssl rand -hex 32
ALGORITHM = "HS256"  # 算法
...
@app04.post("/jwt/token", response_model=Token)
